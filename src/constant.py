...
# 默认语言：中文
zh_cn=['正在解析','域名','报歉,该域名下','来自','的资源暂时不支持爬取','提示','输入exit退出,输入url地址开始爬取','检查URL','URL不可用','URL检查完毕','启动网络爬虫','要爬取的URL地址','程序非正常退出,可能是崩溃了','请向ZZH20081023@163.com发送标题为"BugReport"的邮件,并复制报错信息以及崩溃前的具体操作,感谢您的反馈!','没有叫做','的模式']
